...
docker run -idt --name keycloak -e POSTGRES_USER=keycloak -e POSTGRES_PASSWORD=$PWD -e POSTGRES_DB=keycloak -e KEYCLOAK_USER=admin -e KEYCLOAK_PASSWORD=admin --net=keycloak-net lumeer/keycloak-postgres
