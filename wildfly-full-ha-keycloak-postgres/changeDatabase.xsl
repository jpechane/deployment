...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="//ds:subsystem/ds:datasources/ds:datasource[@jndi-name='java:jboss/datasources/PostgresDS']">
        <ds:datasource jndi-name="java:jboss/datasources/PostgresDS" enabled="true" use-java-context="true" pool-name="PostgresDS" use-ccm="true">
            <ds:connection-url>jdbc:postgresql://postgres:5432/${env.POSTGRES_DATABASE:wildfly}</ds:connection-url>
            <ds:driver>postgresql</ds:driver>
            <ds:security>
              <ds:user-name>${env.POSTGRES_USER:wildfly}</ds:user-name>
